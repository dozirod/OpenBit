        ...
        <section class="mx-auto w-full max-w-md rounded-2xl border border-slate-800 bg-slate-900 p-6 sm:p-8">
            ...
            <form action="#" method="post" class="mt-6 space-y-4">
                <div>
                    ...
                    <input id="name" name="name" type="text" required class="w-full rounded-xl border border-slate-700 bg-slate-950 px-4 py-3 text-slate-100 outline-none placeholder:text-slate-500 focus:border-cyan-500" placeholder="OpenBit User">
                </div>
                <div>
